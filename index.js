...
function resetTest(){
    ...
    //set wpm text
    wpmText.innerHTML = `Goal: <input style="width: 3rem" type="number" value="${goalSpeed}" min="20" onchange="setGoalSpeed(this)"/> words per minute`;
...
function setGoalSpeed(e){
    goalSpeed = Math.max(20, parseInt(e.value));
